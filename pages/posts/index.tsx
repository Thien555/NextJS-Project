...
// ) => {
// 	//server-side and run build-time
// 	const res = await axios.get('https://js-post-api.herokuapp.com/api/posts?_page=1');
// 	console.log(res);
// 	return {
// 		props: { posts: res.data.data.map((x: any) => ({ id: x.id, title: x.title })) },
// 	};
// };
